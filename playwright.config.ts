...
const config: PlaywrightTestConfig = {
  ...
  snapshotPathTemplate: `./__screenshots__/${process.env.CI ? 'CI' : 'local'}/{platform}/{testFilePath}/{projectName}/{arg}{ext}`,
  ...
  use: {
    ...
    baseURL: process.env.TEST_BASE_URL ?? 'https://www.tradingview.com/',
